...
<template>
    <div>
        ...
        >
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yti/ANjgQV8IBlI00ML1mqtDVxplAw27LWlYoz-aWNhyFoIRE_E=s88-c-k-c0x00ffffff-no-rj-mo"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">My profile</div>
            ...
            <span v-if="openMenu"
                ...
                <ul class="text-gray-200 font-semibold text-[14px]">
                    ...
                    <li class="px-3 py-2.5 hover:bg-[#3E3D3D]">Déconnexion</li>
                </ul>
            </span>
        </div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            ...
            <ul>
              <!--insérer une playlist potentiellement-->
            </ul>
        </div>
    </div>
